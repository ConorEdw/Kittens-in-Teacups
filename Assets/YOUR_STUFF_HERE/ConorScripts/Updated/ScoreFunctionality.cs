...
public class ScoreFunctionality : MonoBehaviour
{
    ...
    public TMP_Text distanceNumber;
    public TMP_Text finalScoreNumber;
    ...
    void Update()
    {
        ...
        if (!cannotAccumulate && MinigameBase.minigameStarted)
        {
        ...
        scoreNumber.SetText(currentPlayerScore.ToString() + " M");
        ...
        finalScoreNumber.SetText("Score: " + finalPlayerScore.ToString());
    }
}
